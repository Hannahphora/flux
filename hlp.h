...
#ifndef HLP_ASSERT
#include <assert.h>
#define HLP_ASSERT assert
#endif // HLP_ASSERT

#ifndef HLP_MALLOC
#define HLP_MALLOC malloc
#endif // HLP_MALLOC

#ifndef HLP_REALLOC
#define HLP_REALLOC realloc
#endif // HLP_REALLOC

#ifndef HLP_FREE
#define HLP_FREE free
#endif // HLP_FREE
...
// process handle
#ifdef _WIN32
typedef HANDLE Hlp_Proc;
#define HLP_INVALID_PROC INVALID_HANDLE_VALUE
typedef HANDLE Hlp_Fd;
#define HLP_INVALID_FD INVALID_HANDLE_VALUE
#else
...
// NOTE: hlp_cmd_run_async_and_reset() is just like hlp_cmd_run_async() except it also resets cmd.count to 0
...
// NOTE: hlp_cmd_run_sync_and_reset() is just like hlp_cmd_run_sync() except it also resets cmd.count to 0
